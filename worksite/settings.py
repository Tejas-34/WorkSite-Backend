...
SECRET_KEY = config('SECRET_KEY', default="django-insecure-^x7#^z2+@x*$k%ejm)h7y1gd6fegd44t00-2a^p40tl1zyizwm")
...
if DB_ENGINE == 'django.db.backends.postgresql':
    DATABASES = {
        "default": {
            "ENGINE": DB_ENGINE,
            "NAME": config('DB_NAME', default='worksite_db'),
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'WorkSite API',
    'DESCRIPTION': 'Construction Workforce Job Portal API',
    'VERSION': '1.0.0',
